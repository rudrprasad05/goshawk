...
import CategorySearchCaro from "./CategorySearchCaro";
...
export const ProductFeed = async ({ props }: { props: PageProps }) => {
  ...
  const search = String(props?.searchParams?.search || "0");
  ...
  const allCats = await GetAllParentCategories();
  ...
  return (
    <div className="px-20 py-8">
      ...
      <div>
        <CategorySearchCaro search={search} data={allCats} />
      </div>
